            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="navbar-nav" >
                        ...
                        @if (Auth::user())
                        <li > <a href="{{ url('/home') }}" class="nav-link" style="font-size: 20px; color:white;"> Home </a> </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" style="color:darkred; font-size: 20px;" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
